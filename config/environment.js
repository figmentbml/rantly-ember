...
module.exports = function(environment) {
  var ENV = {
    ...
    contentSecurityPolicy: {
      ...
      'font-src': "'self' http://fonts.gstatic.com http://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/fonts/fontawesome-webfont.woff2?v=4.3.0",  // Allow fonts to be loaded from http://fonts.gstatic.com
